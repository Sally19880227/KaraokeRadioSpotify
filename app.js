...
if(SpeechRecognitionCtor && el.voiceSearchBtn){
  ...
  recognition.addEventListener('error', (e) => {
    ...
    if(e.error === 'network'){
      ...
      // alertはユーザーが閉じるまで処理をブロックするので、キーボードを開く前に案内を読ませてから開く。
      showStatus('この端末では音声検索ボタンが利用できません。キーボードが開いたら、キーボード上のマイクボタンを押してください。');
      alert('この端末では音声検索ボタンが利用できません。\nこの後キーボードが開くので、キーボード上のマイクボタンを押して音声入力してください。');
...
const SCENIC_PHOTO_IDS = [
  10, 11, 13, 14, 15, 16, 17, 19, 22, 23,
  24, 26, 28, 29, 30, 31, 34, 36, 37, 38,
  40, 43, 45, 48, 49, 50, 51, 55, 56, 57,
  58, 59, 60, 62, 63, 64, 65, 66, 67, 68,
  69, 70, 74, 76, 79, 87, 88, 92, 96, 100,
  101, 102, 103, 104, 106, 109, 110, 111, 112, 114,
  117, 118, 119, 122, 128, 129, 130, 133, 134, 135,
